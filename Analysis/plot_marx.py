...
def plot_lightcurve(observationID, repro_wd, tbin):
	...
	tab = read_file(f"/Users/zachsumners/Desktop/15043/repro/marx_sgra_2-8keV_lc300.fits")
	...
	plt.savefig(f'/Users/zachsumners/Desktop/15043/repro/marx_sgra_2-8keV_lc300.png')


def plot_lightcurve_pileup(observationID, repro_wd, tbin):
	'''This function plots the lightcurve that was extracted in lightcurve_extract.py'''
	...
	#Open the pileup corrected lightcurve file.
	tab = read_file(f"/Users/zachsumners/Desktop/15043/repro/marx_sgra_2-8keV_lc300_pileup.fits")
	...
	#Save this plot.
	ax.set_title(f'SgrA* Light Curve - ObsID {observationID} - Obs Start on {obsDate}')
	plt.savefig(f'/Users/zachsumners/Desktop/15043/repro/marx_sgra_2-8keV_lc300_pileup.png')


plot_lightcurve("15043", "/Users/zachsumners/Desktop/15043/repro", 300)
plot_lightcurve_pileup("15043", "/Users/zachsumners/Desktop/15043/repro", 300)