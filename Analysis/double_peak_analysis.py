...
double_peak_indexes = [(10556, 2, 0), (13843, 1, 4), (13847, 1, 2), (13851, 1, 3), (13849, 1, 2), (14462, 2, 3), (14468, 1, 4),
        (14944, 1, 2), (15043, 1, 4), (15042, 2, 2), (15570, 1, 2), (16966, 1, 3), (18732, 1, 0), (20041, 1, 1),
        (20346, 1, 2), (21454, 2, 0), (21456, 1, 1), (25297, 1, 2), (26760, 1, 2), (3393, 1, 1), (3393, 2, 6),
        (5953, 1, 3), (22595, 2, 0), (22595, 1, 0), (14392, 1, 0), (13839, 2, 3)]

def get_index(obsid, flare_num):
    for item in double_peak_indexes:
        if item[0] == obsid and item[1] == flare_num:
            return item[2]
...
for i, flare in enumerate(flare_ids):
    ...
    if flaretype=='double_peak':
        ...
        peak_idx = get_index(int(flare), flare_numbers[i])
        ...
        dx = time[1] - time[0]
        dy_dx = np.gradient(flare_window, dx)
