...
def wcs_correct(observationID, repro_wd, fileName):
	...
	subprocess.call(f'cp ~/Desktop/Research/Chandra/Pipeline/sources_csc.tsv ~/Desktop/Research/Chandra/Pipeline/{observationID}/repro/sources_csc.tsv', shell=True, cwd=repro_wd)
	...
	subprocess.call(f'cp ~/Desktop/Research/Chandra/Pipeline/{observationID}/repro/{observationID}_broad_thresh.img ~/Desktop/Research/Chandra/Pipeline/{observationID}/repro/{observationID}_broad_thresh_img.fits', shell=True, cwd=repro_wd)
