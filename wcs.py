...
def wcs_correct(fp, observationID, repro_wd, fileName):
	...
	subprocess.call(f'wcs_update infile={observationID}_repro_2-8keV_img.fits transformfile={observationID}_xfm.fits outfile=', shell=True, cwd=repro_wd)
	...
	subprocess.call(f'wcs_update infile={observationID}_broad_thresh_img.fits transformfile={observationID}_xfm.fits outfile=', shell=True, cwd=repro_wd)
